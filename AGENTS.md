...
This file provides guidance to Codex (Codex.ai/code) when working with code in this repository. Read it first to understand the architecture, conventions, and constraints before making changes.
