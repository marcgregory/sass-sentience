...
const allNavigation: NavItem[] = [
  ...
  { name: "Groups", href: "/groups", icon: FolderKanban, resource: "device-groups" },
  { name: "Firmware", href: "/firmware", icon: Package, resource: "firmware" },
  { name: "Rollouts", href: "/rollouts", icon: Rocket, resource: "rollouts" },
